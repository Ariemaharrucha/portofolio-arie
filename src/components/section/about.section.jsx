...
export const AboutSection = () => {
  return (
    ...
    <div className='container mx-auto'>
      <h3 className='text-center font-semibold text-white md:mb-10'>{'<About Me />'}</h3>
      <section className='px-8 md:px-0 md:flex items-center md:gap-32 mt-8'>
        <div className='md:w-1/2 w-full text-pretty' data-aos="fade-right">
          <p className='text-pretty md:text-xl text-lg text-white font-medium'>Hello! I am a student at Amikom Yogyakarta, majoring in Informatics. While I am still building my experience, I have developed a strong foundation in web development, particularly with the MERN Stack (MongoDB, Express.js, React, and Node.js). I am passionate about learning and continuously improving my skills in creating web applications. Although I have not yet worked on or completed any major projects, I am eager to apply my knowledge and grow through real-world challenges.</p>
        </div>
        
        <div className="md:w-2/6 mt-5 md:mt-0 shadow-xl rounded-xl overflow-hidden bg-white border-4 border-orange-500" data-aos="fade-left">
