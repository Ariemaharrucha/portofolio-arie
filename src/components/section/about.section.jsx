  ...
  return (
    ...
    <div className='container mx-auto'>
      ...
      <section className='flex items-center gap-32 mt-8'>
        <div className='w-1/2 text-pretty' data-aos="fade-right">
        ...
        <div className="w-2/6 shadow-xl rounded-xl  overflow-hidden bg-white border-4 border-orange-500" data-aos="fade-left">
